    ...
    <div id="add">
        ...
        <form>
            <v-card flat ref="card">
                ...
                <v-snackbar :timeout="snackbar.timeout" :bottom="snackbar.position == 'bottom'" v-model="snackbar.visibility">
                    {{snackbar.text}}
                    <v-btn flat class="pink--text" @click.native="snackbar.visibility = false">Close</v-btn>
                </v-snackbar>
